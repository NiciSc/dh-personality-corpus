...
# this is for scraping a linklist through apis
...
while (offset < 10500):
    ...
    for sorting in sortings:
        ...
        for  subcat_id in subcat_ids:
            response = requests.get(f"https://api.personality-database.com/api/v1/profiles?offset={offset}&limit=500&pid=2&sort={sorting}&cat_id={subcat_id}&property_id=2")
